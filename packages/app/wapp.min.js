/* Version: 1.0.13 - October 28, 2022 14:43:38 */
...
`;
	...
	/* Version: 1.0.38 - October 28, 2022 08:55:42 */
	...
	(function (global, factory) {
	  ...
	  class nbpeer {
	    constructor() {
	      this.eventCB = {};
	      this.enKeys = {};
	      console.log('nbpeer: 1.0.38 - October 28, 2022 08:55:42');
	    }
	    async init() {
	      if (!this.inited) {
	        if (g_isBrowser) {
	    ...
	    async restoreEnkeys() {
	      ...
	      try {
	        ...
	        for (id in idKeyMap) {
	          this.setEncryptKey(idKeyMap[id], id);
	        }
	        return true;
	      } catch (e) {
	        return false;
	    ...
	    setEncryptKey(enKey, desid) {
	      ...
	      localStorage.setItem("id_key_map", JSON.stringify(this.enKeys));
	    }
