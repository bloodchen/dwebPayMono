/* Version: 1.0.6 - October 18, 2022 10:16:59 */
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('socket.io-client'), require('eccrypto-js'), require('cross-fetch')) :
	typeof define === 'function' && define.amd ? define(['socket.io-client', 'eccrypto-js', 'cross-fetch'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.WalletApp = factory(global.require$$0, global.require$$1, global.require$$2));
})(this, (function (require$$0, require$$1, require$$2) { 'use strict';
...
`;
	...
	/* Version: 1.0.30 - October 18, 2022 09:08:01 */
	...
	(function (global, factory) {
	  ...
	  class nbpeer {
	    constructor() {
	      this.eventCB = {};
	      this.enKeys = {};
	      console.log('nbpeer: 1.0.30 - October 18, 2022 09:08:01');
	    }
	    async init() {
	      if (!this.inited) {
	        if (g_isBrowser) {
	          ...
	          io = require$$0__default["default"].io;
	          eccryptoJS = require$$1__default["default"];
	          fetch = require$$2__default["default"];
	        }
	        this.inited = true;
	      }
	    }
